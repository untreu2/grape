...
class _TransferCardState extends State<TransferCard> {
  ...
  void didUpdateWidget(covariant TransferCard oldWidget) {
    ...
    if (widget.selectedFiatCurrency != oldWidget.selectedFiatCurrency ||
        widget.tx != oldWidget.tx) {
      _fetchFiatValue();
    }
  }
  ...
  Future<void> _fetchFiatValue() async {
    ...
    try {
      double? newValue = await walletProvider.convertSatoshisToCurrency(
          amount, widget.selectedFiatCurrency);
  ...
  Widget build(BuildContext context) {
    ...
    final String fiatSymbol =
        widget.currencySymbols[widget.selectedFiatCurrency] ?? '';
